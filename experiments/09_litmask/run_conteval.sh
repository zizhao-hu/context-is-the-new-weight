...
#SBATCH --output=/project2/jessetho_1732/zizhaoh/context-is-the-new-weight/logs/conteval_%j.log
#SBATCH --error=/project2/jessetho_1732/zizhaoh/context-is-the-new-weight/logs/conteval_%j.log
set -eo pipefail
...
MASK=$1
EXTRA="${@:2}"
echo "CONTEVAL_START mask=$MASK extra=$EXTRA"
python $EXP/toy_conteval.py --mask $MASK $EXTRA
echo "CONTEVAL_JOBDONE mask=$MASK"
