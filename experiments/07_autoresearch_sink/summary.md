...
## Folded into the paper (`paper/attention-sink/`)
Strict-control table (Tab.~strict), Type-1→Type-2 spread figure+table (Fig.~spread / Tab.~spread), compute-efficiency table (Tab.~eff), persist-recovers-QA paragraph, and the honest 3c scoping (spread ≠ retrieval). Compiles clean, 6 pp.
