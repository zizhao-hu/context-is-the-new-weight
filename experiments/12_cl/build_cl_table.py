...
def main():
    ...
    out.append(r"backward transfer (drop from just after each task's stage to the end, positive")
    out.append(r"helps), and the never-trained fineweb probe. Matched deploy per design; base rows")
    out.append(r"under full attention; the hybrid trains $50$ steps per stage. Per-task numbers in")
